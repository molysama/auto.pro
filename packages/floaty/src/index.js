...
function createFloaty(_a) {
    ...
    ] : _h, _j = _b.initX, initX = _j === void 0 ? -2 : _j, _k = _b.initY, initY = _k === void 0 ? core_1.height / 2 : _k;
    ...
    down$.pipe(operators_1.map(function (e) { return ({ dx: e.getRawX(), dy: e.getRawY(), sx: STAND.getX(), sy: STAND.getY() }); }), operators_1.switchMap(function (_a) {
        ...
        up$.pipe(operators_1.skipUntil(move$), operators_1.tap(function (e_up) {
            ...
            if (upX < 100) {
                ...
                STAND.setPosition(core_1.width - size + 2, nowY);
                FLOATY.setPosition(core_1.width - FLOATY_STAND_OFFSET_X - size + 2, nowY - FLOATY_STAND_OFFSET_Y);
            }
        })));
    })).subscribe();
