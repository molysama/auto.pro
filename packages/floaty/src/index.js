...
export function createFloaty(_a) {
    ...
    ] : _h, _j = _b.initX, initX = _j === void 0 ? -2 : _j, _k = _b.initY, initY = _k === void 0 ? getHeightPixels() / 2 : _k;
    // 每个被创建的悬浮窗都有自己的唯一UID，此UID可以正确的触发自己的事件
    var FLOATY_UID = uuidjs.create(4).toString();
    ...
    var down$ = logoTouch$.pipe(filter(function (e) { return e.getAction() === e.ACTION_DOWN; }));
    // 悬浮窗仅当关闭时可以移动
    ...
    var up$ = logoTouch$.pipe(filter(function (e) { return e.getAction() === e.ACTION_UP; }));
