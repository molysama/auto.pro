...
export function createFloaty(_a) {
    ...
    ] : _h, _j = _b.initX, initX = _j === void 0 ? -2 : _j, _k = _b.initY, initY = _k === void 0 ? getHeightPixels() / 2 : _k, _l = _b.edge, edge = _l === void 0 ? -2 : _l, _m = _b.moveLimit, moveLimit = _m === void 0 ? 50 : _m;
