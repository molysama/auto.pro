 ...
 */
export const swipe = (startPoint: [number, number], endPoint: [number, number], duration?: number) => {
 ...
 */
export const click = (x: number, y: number, delay: [number, number] = [600, 800], randomOffsetX: number = 0, randomOffsetY: number = 0) => {
    if (x == null || y == null) {
        return
    }
 ...
 */
export const clickRes = (x: number, y: number, delay: [number, number] = [600, 800], randomOffsetX: number = 0, randomOffsetY: number = 0) => {
