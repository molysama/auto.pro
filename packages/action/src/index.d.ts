...
export declare let clickOP: (x: number, y: number, delay?: [number, number] | [600, 800], randomOffsetX?: number, randomOffsetY?: number) => (source: any) => Observable<[number, number]>;
/**
